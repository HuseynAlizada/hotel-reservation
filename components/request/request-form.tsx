...
export function RequestForm({ onCancel }: { onCancel?: () => void }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-white rounded-[2rem] overflow-hidden max-w-[880px] w-full mx-auto shadow-[0_8px_40px_rgba(0,0,0,0.08)]">
      {/* Left: Laptop Image */}
      <div className="relative lg:w-[46%] min-h-[260px] lg:min-h-[500px] bg-[#d6d3ce]">
        <Image
      ...
      {/* Right: Form */}
      <div className="flex-1 flex flex-col px-8 py-8 lg:px-10 lg:py-10 relative">
        {/* Status icons */}
        ...
        <h2 className="text-[#1a1a2e] text-2xl font-semibold italic mb-8">Request</h2>
