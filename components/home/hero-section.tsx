...
export function HeroSection() {
  return (
    <section 
      className="relative w-full overflow-hidden min-h-screen flex items-end bg-white"
    >
      {/* Banner Background Image at top */}
      <div 
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6 lg:px-8 w-full pb-20 md:pb-32">
